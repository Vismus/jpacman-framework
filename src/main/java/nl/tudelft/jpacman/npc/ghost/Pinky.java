...
public class Pinky extends Ghost {
    ...
    private static final int SQUARES_AHEAD = Integer.parseInt(ConfigurationLoader.getProperty("ghost.pinky.squares.ahead"));

    /**
     * The variation in intervals, this makes the ghosts look more dynamic and
     * less predictable.
     */
    private static final int INTERVAL_VARIATION = Integer.parseInt(ConfigurationLoader.getProperty("ghost.pinky.interval.variation"));

    /**
     * The base movement interval.
     */
    private static final int MOVE_INTERVAL = Integer.parseInt(ConfigurationLoader.getProperty("ghost.pinky.move.interval"));
